...
+ (id)authorizationWebViewWithCompletionHandler:(void (^)(NSError *error))completionHandler {
...
+ (id)signupWebViewWithCompletionHandler:(void (^)(NSError *error))completionHandler {
...
+ (id)forgotPasswordWebViewWithCompletionHandler:(void (^)(NSError *error))completionHandler {
