...
- (id)initWithJSONData:(NSData *)data {
    ...
    if (self) {
        ...
        if ([data length] > 0) {
            ...
            [self setError:[NSError apiErrorWithCode:SPiDUserAbortedLogin reason:@"ApiException" descriptions:[NSDictionary dictionaryWithObjectsAndKeys:@"Recevied empty response", @"error", nil]]];
        }
    }
    return self;
}
